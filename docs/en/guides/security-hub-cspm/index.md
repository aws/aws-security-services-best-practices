...
AWS Security Hub has Insights allow you to view your findings through different visualizations. Most customers use the default Insights and create custom insights to focus on finding trends that require attention. Below are some best practices of creating insights:
